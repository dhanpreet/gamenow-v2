...
<div class="wrapper">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <br><br>
            <h6 class="mb-0 text-uppercase">Advertisement's List</h6>
            <hr/>
            <div class="card">
                <div class="card-body">		
                    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="adTable" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="14%">Advertisement<br> &nbsp; </th>
                                    <th width="14%" class="text-center">Image<br> &nbsp; </th>
                            ...
                            <?php if(is_array($list) && count($list)>0){ ?>
                                <?php foreach($list as $row){ ?>
                                    <tr>
                                            <td width="14%"><?php echo ucfirst($row['ad_text_main']); ?></td>
                                            <td width="14%" class="text-center">
                                                <a href="<?php echo site_url('Admin/ManageAdvertisementImages/'.base64_encode($row['id'])) ?>" class="btn btn-sm btn-secondary radius-30">
                                            ...
                                            <td width="14%" class="text-center">
                                                <a href="<?php echo site_url('Admin/editAdvertisement/'.base64_encode($row['id'])) ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3 text-primary">
