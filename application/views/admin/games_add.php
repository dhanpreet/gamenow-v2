			...
			<div class="page-content">
				...
				<div class="card">
					...
					<div class="row">
						...
						<br><br>
							<form action="<?php echo site_url('admin/processPartnerGame') ?>" method="post" class="row g-3 px-3 needs-validation" novalidate autocomplete="new-password">
							...
							<div class="row mb-4">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="game_name"  id="game_name" autocomplete="new-password" required />
								</div>
							</div>
							...
							<div class="row mb-4">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="game_category" id="game_category" autocomplete="new-password" required />
								</div>
							</div>
							...
							<div class="row mb-4">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="game_genre" id="game_genre" autocomplete="new-password" required />
							...
							<div class="row mb-4">
								...
								<div class="col-sm-8">
									<input type="url" class="form-control" name="game_play_link" id="game_play_link" autocomplete="new-password" required />
									<span id="username_error_hint" class="text-danger mt-1"></span>
								</div>
							</div>
							...
							<div class="row mb-5">
								...
								<div class="col-sm-8">
									<div class="row">
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_top_banner" id="checkbox-7" value="1" checked>
											<label class="form-check-label" for="checkbox-7">Top Hero Banner</label>
										</div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_page_banner" id="checkbox-8" value="1" checked>
											<label class="form-check-label" for="checkbox-8">Page Banner</label>
										</div>
										<div class="col-sm-12"> <br> </div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_popular" id="checkbox-1" value="1" >
											<label class="form-check-label" for="checkbox-1">Popular Games</label>
										</div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_mini_games" id="checkbox-2" value="1">
											<label class="form-check-label" for="checkbox-2">Mini Games</label>
										</div>
										<div class="col-sm-12"> <br> </div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_top_chart" id="checkbox-3" value="1">
											<label class="form-check-label" for="checkbox-3">Top Chart Games</label>
										</div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_tournament" id="checkbox-4" value="1">
											<label class="form-check-label" for="checkbox-4">Tournaments Games</label>
										</div>
										<div class="col-sm-12"> <br> </div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_most_played" id="checkbox-5" value="1">
											<label class="form-check-label" for="checkbox-5">Mostly Played Games</label>
										</div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="checkbox" name="game_free_to_play" id="checkbox-6" value="1">
							...
							<div class="row mb-5">
								...
								<div class="col-sm-8">
									<div class="row">
										<div class="col-sm-3">
											<input class="form-check-input" type="radio" name="game_status" id="radio-1" value="1"/>
											<label class="form-check-label" for="radio-1">Approve</label>
										</div>
										<div class="col-sm-3">
											<input class="form-check-input" type="radio" name="game_status" id="radio-2" value="2" checked />
											<label class="form-check-label" for="radio-2">Publish</label>
										</div>
										<div class="col-sm-3">
											<input class="form-check-input" type="radio" name="game_status" id="radio-3" value="3"/>
											<label class="form-check-label" for="radio-3">Reject</label>
										</div>
										
										<div class="col-sm-3">
											<input class="form-check-input" type="radio" name="game_status" id="radio-4" value="4"/>
							...
							<div class="row mb-4">
								<div class="col-sm-12 text-center">
									<button type="submit" class="col-4 btn btn-success radius-30">Save Game</button>
								</div>
							</div>
