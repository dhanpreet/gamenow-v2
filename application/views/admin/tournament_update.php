			...
			<div class="page-content">
				...
				<div class="card">
					...
					<div class="row">
						...
						<br><br>
							<form action="<?php echo site_url('Admin/AddTournament/'.base64_encode($info['tournament_id'])) ?>" method="post" class="row g-3 px-3 needs-validation" novalidate autocomplete="new-password">
						
							<div class="row mb-4">
								<label for="tournament_name" class="col-sm-4 col-form-label">Tournament Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="tournament_name" id="tournament_name" value="<?php echo $info['tournament_name']; ?> " autocomplete="new-password" required />
							...
							<div class="row mb-4">
								...
								<div class="col-sm-8">
									...
									<option value="<?php echo $partner['partner_id'] ?>" <?php if($partner['partner_id']== $info['partner_id']) echo 'selected' ?> ><?php echo $partner['partner_name'] ?></option>
									<?php } ?>
									</select>
								</div>
							</div>
							...
							<div class="row mb-5">
								...
								<div class="col-sm-8">
									<div class="row">
										<!-- <div class="col-sm-4"> -->
											<!-- <input class="form-check-input" type="radio" name="tournament_status" id="radio-2" value="1" <?php if($info['tournament_status']==1) echo 'checked'; ?> />
											<label class="form-check-label" for="radio-2">Approve</label> -->
										<!-- </div> -->
										<div class="col-sm-6">
											<input class="form-check-input" type="radio" name="tournament_status" id="radio-3" value="2" <?php if($info['tournament_status']==2) echo 'checked'; ?>/>
											<label class="form-check-label" for="radio-3">Active</label>
										</div>
										
										<div class="col-sm-6">
											<input class="form-check-input" type="radio" name="tournament_status" id="radio-4" value="4" <?php if($info['tournament_status']==4) echo 'checked'; ?>/>
							...
							<div class="row mb-4">
								<div class="col-sm-12 text-center">
									<button type="submit" class="col-4 btn btn-success radius-30">Update Tournament</button>
								</div>
							</div>
