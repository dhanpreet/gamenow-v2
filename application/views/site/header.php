...
<div class="header-strip" style="border-bottom: 1px solid #312b2b; padding-bottom:10px;">
	...
	<a href="javascript(0);" data-toggle="modal" data-target="#updateProfileImage"> <span class="profile-picture"><img src="<?php echo base_url() ?>assets/frontend/img/demo-user.png"> </span> </a>
