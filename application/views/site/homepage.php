...
<meta name="description" content="Discover and Play the Latest Mobile Games and Apps. No data charges">
<meta name="keywords" content="games, pubg, ninja">
...
<section>
	<div class="container">
		...
		<div class="row">
			<div class="glider-contain">
				...
				<!-- <iframe width="100vw" height="400" src="https://www.youtube.com/embed/3ZOTKVwRTBM?&autoplay=1&mute=0&enablejsapi=1" title="YouTube video player" allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe> -->
				
				
				<!-- <iframe width="100vw" height="400" src="https://www.youtube.com/embed/km9vwdg6fYk?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>   -->
				
				<!-- <iframe width="100vw" height="400" src="https://www.youtube.com/embed/JxKlszutMno?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!-- <iframe width="100vw" height="400" src="https://www.youtube.com/embed/__t_wffvw3w?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!-- <iframe width="100vw" height="400" src="https://www.youtube.com/embed/Aueqxb0WfCg?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/pMkVvoQRURs?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/egEzZgKUhwc?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/0CccCbfHG1M?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/3ccZQGOXM4M?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/qmzWeaUrJSE?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/qCoQdt-ioIA?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/ujoUhv2iFao?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/KnX5XTCr2dY?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/CMpfS3GpCZw?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/gVeELdoaupQ?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				<!--
				<iframe width="100vw" height="400" src="https://www.youtube.com/embed/ZEO9HKFo1wQ?&autoplay=1&mute=0&enablejsapi=1"  allow="autoplay" frameborder="0"  allowfullscreen allowautoplay ></iframe>
				-->
				
				
				<?php /*  foreach($tournamentGamesBanners as $rowHero){ ?>
				...
				<?php foreach($heroBanners as $rowHero){ ?>
				<?php if(!empty($rowHero['img_gif_link']) && ($hCount== 1 || $hCount== 3)){ ?>
		...
		<div class="row">
			<div class="glider-contain">
				<div class="glider-05">
					...
					<?php  foreach($tournamentGamesSpec as $rowTournamentPopular){ ?>
	...
	<div id="premium" class="tab-pane fade">
		...
		<div class="row">
			...
			<?php  foreach($fullTournamentGamesBanners as $rowFullTournament){ ?>
				<a href="<?php echo $rowFullTournament['game_play_link'] ?>">
					<div class="single-banner">
						<?php if($fCount%2 == 0){ ?>
						<img class="img-responsive" alt="<?php echo $rowFullTournament['game_name'] ?>" src="<?php echo base_url('uploads/content/'.$rowFullTournament['img_link']) ?>">
