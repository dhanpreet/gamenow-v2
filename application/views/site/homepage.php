...
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/frontend/fontawesome-5.15.1/css/all.min.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/frontend/fontawesome-5.15.1/css/brands.min.css" rel="stylesheet">
	...
	<div class="container">
		...
		<div id="for-you" class="tab-pane fade in active">
                    ...
                    <div class="row ads-style">
                        <div class="ad_image">
                            ...
                            ?>
                            <img class="lazyload" data-src="<?php echo base_url('uploads/ads/'.$ad_image) ?>" loading="lazy"/>
                        </div>                        
                        <div class="ad_text">
			...
			<div class="row">
                            <div class="single-banner free_tournament_div">
                                ...
                                <a href="<?php echo $freeTournament[0]['tournament_play_link'] ?>">
                                    <img class="img-responsive lazyload" alt="<?php echo $freeTournament[0]['tournament_name'] ?>" data-src="<?php echo $tournament_image; ?>" loading="lazy">
                                </a>
                            </div>
			</div>
                    <?php } ?>
		...
		<div class="row">
			<div class="glider-contain">
				...
				<?php if(!empty($rowHero['tour_img_img_gif']) && ($hCount== 1 || $hCount== 3)){ ?>
					...
					<a href="<?php echo $rowHero['tournament_play_link'] ?>"><img class="lazyload" width="100%" alt="<?php echo $rowHero['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowHero['tour_img_img_gif']) ?>" loading="lazy"><span class="play-icon"><i class="fa fa-play"></i></span></a>
				<?php } else { ?>
						<a href="<?php echo $rowHero['tournament_play_link'] ?>"><img class="lazyload" width="100%" alt="<?php echo $rowHero['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowHero['tour_img_img_link']) ?>" loading="lazy"><span class="play-icon"><i class="fa fa-play"></i></span></a>
				...
				<?php $pCount = 1; foreach($popularGamesBanners as $rowPopular){ ?>
					<a href="<?php echo $rowPopular['game_play_link'] ?>">
						<div>
							...
							<?php } */ ?>
								<img style="border-radius:20px;" alt="<?php echo $rowPopular['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowPopular['img_link']) ?>" loading="lazy" class="lazyload">
		...
		<?php if(!empty($pageBanners[0])){ ?>
			<div class="row">
				<div class="single-banner">
					<a href="<?php echo $pageBanners[0]['game_play_link'] ?>"><img class="img-responsive lazyload" alt="<?php echo $pageBanners[0]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[0]['img_link']) ?>" loading="lazy"></a>
				</div>
			</div>
		<?php } ?>
                ...
                <!-- Advertisement 2 -->
                    ...
                    <div class="row ads-style">
                        <div class="ad_image">
                            ...
                            ?>
                            <img data-src="<?php echo base_url('uploads/ads/'.$ad_image) ?>" loading="lazy" class="lazyload"/>
                        </div>                        
                        <div class="ad_text">
                            <h4><?php echo $ads_list[$random_ad]['ad_text_main']; ?></h4>
                            <p><?php echo $ads_list[$random_ad]['ad_text_mini']; ?></p>
				...
				<div class="glider-5">
					<?php $tCount = 1; foreach($tournamentGamesThumbs as $rowTournament){ ?>
						<a href="<?php echo $rowTournament['tournament_play_link'] ?>">
							<div>
								<img style="border-radius:20px;" alt="<?php echo $rowTournament['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowTournament['tour_img_img_link']) ?>" loading="lazy" class="lazyload">
					...
					<?php  foreach($tournamentGamesSpec as $rowTournament){ ?>
						<a href="<?php echo $rowTournament['game_play_link'] ?>">
							<div>
								<img style="border-radius:20px;" alt="<?php echo $rowTournament['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowTournament['img_link']) ?>" loading="lazy" class="lazyload">
		...
		<div class="row">
			...
			<div class="glider-4">
				...
				<a href="<?php echo $pageBanners[1]['game_play_link'] ?>"><img width="100%" alt="<?php echo $pageBanners[1]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[1]['img_link']) ?>" loading="lazy" class="lazyload"><span class="play-icon"><i class="fa fa-play"></i></span></a>
				<?php } ?>
				
				<?php if(!empty($pageBanners[2]['game_play_link'])){ ?>
					<?php if(!empty($pageBanners[2]['img_gif_link'])){ ?>
						<a href="<?php echo $pageBanners[2]['game_play_link'] ?>"><img width="100%" alt="<?php echo $pageBanners[2]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[2]['img_gif_link']) ?>" loading="lazy" class="lazyload"><span class="play-icon"><i class="fa fa-play"></i></span></a>
					<?php } else { ?>
						<a href="<?php echo $pageBanners[2]['game_play_link'] ?>"><img width="100%" alt="<?php echo $pageBanners[2]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[2]['img_link']) ?>" loading="lazy" class="lazyload"><span class="play-icon"><i class="fa fa-play"></i></span></a>
					<?php } ?>
				<?php } ?>
				
				
				<?php if(!empty($pageBanners[3]['game_play_link'])){ ?>
				<a href="<?php echo @$pageBanners[3]['game_play_link'] ?>"><img width="100%" alt="<?php echo $pageBanners[3]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[3]['img_link']) ?>" loading="lazy" class="lazyload"><span class="play-icon"><i class="fa fa-play"></i></span></a>
				<?php } ?>
					...
					<a href="<?php echo $rowMostlyPlayed['game_play_link'] ?>">
						<div>
							<?php if(!empty($rowMostlyPlayed['img_gif_link']) && $mpCount%2 != 0){ ?>
								<img style="border-radius:20px;" alt="<?php echo $rowMostlyPlayed['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowMostlyPlayed['img_gif_link']) ?>" loading="lazy" class="lazyload">
							<?php } else { ?>
								<img style="border-radius:20px;" alt="<?php echo $rowMostlyPlayed['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowMostlyPlayed['img_link']) ?>" loading="lazy" class="lazyload">
							<?php } ?>
						...
						<div>
							<?php foreach($freeGamesBanners[0] as $rowFree){ ?>
								<a href="<?php echo $rowFree['game_play_link'] ?>">
									<div class="row thumbnails">
										<div class="col-xs-12"><img alt="Test" data-src="<?php echo base_url('uploads/content/'.$rowFree['img_link']) ?>" loading="lazy" class="lazyload"></div>
						...
						<div>
							<?php foreach($freeGamesBanners[1] as $rowFree_1){ ?>
								<a href="<?php echo $rowFree_1['game_play_link'] ?>">
									<div class="row thumbnails">
										<div class="col-xs-12"><img alt="Test" data-src="<?php echo base_url('uploads/content/'.$rowFree_1['img_link']) ?>" loading="lazy" class="lazyload"></div>
						...
						<div>
							<?php foreach($freeGamesBanners[2] as $rowFree_2){ ?>
								<a href="<?php echo $rowFree_2['game_play_link'] ?>">
									<div class="row thumbnails">
										<div class="col-xs-12"><img alt="Test" data-src="<?php echo base_url('uploads/content/'.$rowFree_2['img_link']) ?>" loading="lazy" class="lazyload"></div>
		...
		<div id="free-games" class="tab-pane fade">
			...
			<div class="row">
                            <div class="single-banner free_tournament_div">
                                ...
                                ?>
                                <a href="<?php echo $freeTournament[0]['tournament_play_link'] ?>">
                                    <img class="img-responsive" alt="<?php echo $freeTournament[0]['tournament_name'] ?>" data-src="<?php echo $tournament_image; ?>" loading="lazy" class="lazyload">
                                </a>
                            </div>
			</div>
                    <?php } ?>
					...
					<?php $tCount=1; foreach($freeGames as $rowfreeGame){ ?>
							...
							<div class="row thumbnails">
								<?php if(!empty($rowfreeGame['img_gif_link']) && $tCount%3 == 0){ ?>
									<div class="col-xs-3"><img alt="<?php echo $rowfreeGame['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowfreeGame['img_gif_link']) ?>" loading="lazy" class="lazyload"></div>
								<?php } else { ?>
									<div class="col-xs-3"><img alt="<?php echo $rowfreeGame['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowfreeGame['img_link']) ?>" loading="lazy" class="lazyload"></div>
								<?php } ?>
			...
			<a href="<?php echo @$pageBanners[4]['game_play_link'] ?>">
				<div class="single-banner">
					<?php if(!empty($pageBanners[4]['img_gif_link'])){ ?>
						<img class="img-responsive lazyload" alt="<?php echo $pageBanners[4]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[4]['img_gif_link']) ?>" loading="lazy">
					<?php } else { ?>	
						<img class="img-responsive lazyload" alt="<?php echo $pageBanners[4]['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$pageBanners[4]['img_link']) ?>" loading="lazy">
					<?php }  ?>
				</div>
			</a>
		</div>
				...
				<div class="glider-05">
					<?php  foreach($tournamentGamesThumbs as $rowTournamentPopular){ ?>
						<a href="<?php echo $rowTournamentPopular['tournament_play_link'] ?>">
							<div>
								<img style="border-radius:20px;" alt="<?php echo $rowTournamentPopular['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowTournamentPopular['tour_img_img_link']) ?>" loading="lazy" class="lazyload">
				...
				<a href="<?php echo $rowPopular_2['game_play_link'] ?>">
					<div class="row thumbnails">
						<?php if(!empty($rowPopular_2['img_gif_link']) && $pCount%2 == 0){ ?>
							<div class="col-xs-3"><img alt="<?php echo $rowPopular_2['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowPopular_2['img_gif_link']) ?>" loading="lazy" class="lazyload"></div>
						<?php } else { ?>
							<div class="col-xs-3"><img alt="<?php echo $rowPopular_2['game_name'] ?>" data-src="<?php echo base_url('uploads/content/'.$rowPopular_2['img_link']) ?>" loading="lazy" class="lazyload"></div>
						<?php } ?>
		...
		<div class="row">
			<?php $fCount=1;  foreach($tournamentGamesBanners as $rowFullTournament){ ?>
				<a href="<?php echo $rowFullTournament['tournament_play_link'] ?>">
					<div class="single-banner">
						<?php if($fCount%2 == 0){ ?>
						<img class="img-responsive lazyload" alt="<?php echo $rowFullTournament['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowFullTournament['tour_img_img_link']) ?>" loading="lazy">
						<?php } else { ?>
							<?php if(!empty($rowFullTournament['tour_img_img_gif'])){ ?>
								<img class="img-responsive lazyload" alt="<?php echo $rowFullTournament['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowFullTournament['tour_img_img_gif']) ?>" loading="lazy">
							<?php } else { ?>
								<img class="img-responsive lazyload" alt="<?php echo $rowFullTournament['tournament_name'] ?>" data-src="<?php echo base_url('uploads/tournaments/'.$rowFullTournament['tour_img_img_link']) ?>" loading="lazy">
							<?php } ?>
						<?php } ?>
				...
				<div class="row upload-login-image">
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center avatar-player-name">
						<div class="relative img-icon upload-login-image">
							<img id="user-img-login" data-src="<?php echo base_url() ?>uploads/site_users/default.png"  style="border:1px solid #efefef; padding:5px; background:#2b2b2b; border-radius:50%; width:120px;" class="lazyload"/>
...
<script src="<?php echo base_url() ?>assets/frontend/js/lazyload.js"></script>
...
$(document).ready(function(){   
    ...
    // get mini games
    $.ajax({
        url : "<?php echo site_url('site/getMiniGames') ?>",
        type: "POST",
        success: function(data){
            $('#mini_games_list').html(data);
        }
    });
