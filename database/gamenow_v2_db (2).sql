...
--
-- Host: localhost
-- Generation Time: Oct 25, 2021 at 05:51 AM
...
CREATE TABLE IF NOT EXISTS `tbl_partners_tournaments` (
  ...
  `tournament_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=AddedOnly 1=Approved  2=Published  3=Reject  4=Inactive',
